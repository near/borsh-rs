        ...
        assert_eq!(
            map! {
                "XY" => Definition::Enum {
                    tag_width: 1,
                    variants: vec![
                         (0, "A".to_string(), "()".to_string()),
                         (20, "B".to_string(), "()".to_string()),
                         (21, "C".to_string(), "()".to_string()),
                         (22, "D".to_string(), "XYD".to_string()),
                         (10, "E".to_string(), "()".to_string()),
        ...
        assert_eq!(
            map! {
                "XYNoDiscriminant" => Definition::Enum {
                    ...
                    variants: vec![
                         (0, "A".to_string(), "()".to_string()),
                         (1, "B".to_string(), "()".to_string()),
                         (2, "C".to_string(), "()".to_string()),
                         (3, "D".to_string(), "XYNoDiscriminantD".to_string()),
                         (4, "E".to_string(), "()".to_string()),
