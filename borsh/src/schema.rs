...
pub enum Definition {
    ...
    Sequence {
        ...
        /// `length_range` will contain only one number.  
        /// In the latter case, it may be impossible to deserialise the data without
...
impl Definition {
    ...
    /// sequence.
    ///
    /// Can be used for `Definition::Sequence::length_range`.
